    ...
    for json_file in json_files:
        with open(json_file, 'r', encoding='utf-8') as file:
            try:
                ...
                result_entry = {
                    'ac_no': ac_number,
                    'Mahayuti': candidates.get("Mahayuti", [0, 0])[1],
                    'Maha Vikas Aghadi': candidates.get("Maha Vikas Aghadi", [0, 0])[1],
                    'Others': candidates.get("Others", [0, 0])[1],
                    'Cost': cost,
                    'Samples': samples,
                    'Funnel Rate': funnel_rate
                }
...
if __name__ == "__main__":
    ...
    op_excel_file = rf"D:\Alliance_votes_summary1.xlsx"
